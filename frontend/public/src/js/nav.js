...
const ROUTES = window.NetoRoutes || {
  user: {
    dashboard: '/html/user/dashboard.html',
    stats: '/html/user/stats.html',
    expenses: '/html/user/expenses.html',
    expensesUpload: '/html/user/expenses-upload.html',
    expensesOrganize: '/html/user/expenses-organize.html',
    planning: '/html/user/planning.html',
    goals: '/html/user/goals.html',
    chatAi: '/html/user/chat-ai.html',
    chatAdvisor: '/html/user/chat-advisor-user.html',
    profile: '/html/user/profile.html',
  },
  advisor: {
    dashboard: '/html/advisor/advisor.html',
    users: '/html/advisor/advisor-users.html',
    detail: '/html/advisor/advisor-detail.html',
    chats: '/html/advisor/advisor-chats.html',
  },
};
...
function linkMarkup(item, currentPage) {
  const href = resolveRoute(item.href);
  ...
  return `<a class="chip${activeClass}" href="${href}" aria-label="${item.label}"${ariaCurrent}>
...
function renderSidebar(options = {}) {
  ...
  const isAdvisorPath = window.location.pathname.includes('/html/advisor/');
  const isAdvisorArea = body.hasAttribute('data-advisor-page') || isAdvisorPath || currentRole === 'ADVISOR';
  ...
  const userGestionLinks = [
    ...
    {
      href: ROUTES.user.expensesUpload,
      label: 'Subir Ticket',
    ...
    {
      href: ROUTES.user.expensesOrganize,
  ...
  nav.innerHTML = `
    <div class="container">
      <a class="subnav-brand" href="${isAdvisorArea ? ROUTES.advisor.dashboard : ROUTES.user.dashboard}" aria-label="Neto">
